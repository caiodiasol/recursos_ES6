...
const alunos = ['Carlos', 'Paulo', 'Maria', 'Julia'];
...
const maria = alunos2.find(function(itemAtual){
...
const indiceDoPaulo = alunos2.findIndex(function(itemAtual){
...
//every - todos
const todosAlunosSaoFrontend = alunos2.every(function(itemAtual){
...
const existeAlgumAlunoBackend = alunos2.some(function(itemAtual){
